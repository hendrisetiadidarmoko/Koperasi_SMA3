    ...
    <div class="w-100 border-content rounded my-5 bg-light">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="order-md-1 order-last">
                        <h3 class="text-center">Pilih Transaksi Bulan untuk Tahun {{ $year }}</h3>
                    </div>
                </div>
            </div>
        </div>
        <section class="section mt-4 p-3 ">
            ...
            {{-- <div class="d-flex align-items-center">
                <a href="{{ route('report.year.pdf', ['year' => $year]) }}" class="btn btn-success w-100 fs-4 d-none d-sm-inline">
